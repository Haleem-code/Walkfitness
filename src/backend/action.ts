...
// Note: The following functions (checkAndUpdateStreak and getUserStreak) are not included
// as they were not visible in the original file. Please provide their implementations
// if you'd like them to be included in the TypeScript version.
