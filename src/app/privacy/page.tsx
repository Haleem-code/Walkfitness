...
const PrivacyPolicy = () => {
  return (
    <div style={{ padding: '2rem', color: '#fff', backgroundColor: '#000', lineHeight: '1.6', fontFamily: 'Arial, sans-serif',marginTop:"4rem" }}>
      <h1 style={{ color: '#CEFF67', textAlign: 'center' }}>Privacy Policy</h1>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p>
          <strong>Activity Data:</strong> As a health and fitness website, WALKFIT helps you maintain your health by tracking your level of physical activity, such as the number of steps according to Google Fit.
        </p>
        <p>
          <strong>Usage Data:</strong> We could also gather data concerning your behavior on the site, the pages you visit, and the time spent on each page through programs such as Google Analytics.
        </p>
      </div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <ul>
          <li>Ensure that we offer and enhance the services that customers need, such as tracking activities and incentivizing them for their fitness.</li>
          <li>Continuously track usage patterns and trends on the web, such as through Google Analytics.</li>
        </ul>
      </div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p>
          <strong>Legal Requirements:</strong> We may share your information if we are legally mandated to do so or as part of a legal process.
        </p>
      </div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <ul>
          ...
          <li><strong>Erasure:</strong> There are conditions under which you may require that your personal data be erased.</li>
          <li><strong>Restriction:</strong> You have the right to restrict processing, which means you can ask for the data not to be processed.</li>
          <li><strong>Objection:</strong> You have the right to object to the processing of your data.</li>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p>
          <strong>Third-Party Tracking:</strong> We utilize third-party analytics tools, including Google Analytics, which track user activity; however, we do not disclose your information to third parties engaged in advertising.
        </p>
      </div>
